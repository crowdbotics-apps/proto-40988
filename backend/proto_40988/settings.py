"""
Django settings for proto_40988 project.
...
WSGI_APPLICATION = 'proto_40988.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "proto_40988 API",
    "DESCRIPTION": "API documentation for proto_40988 App",
    "VERSION": "v1",
}
